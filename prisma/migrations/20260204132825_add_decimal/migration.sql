/*
  ...
  - You are about to alter the column `fibers` on the `nutrition_facts` table. The data in that column could be lost. The data in that column will be cast from `DoublePrecision` to `Decimal(65,30)`.
...
ALTER COLUMN "fibers" SET DATA TYPE DECIMAL(65,30);
